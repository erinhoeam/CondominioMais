...
export class DateUtils {
    ...
    public static getMyDatePickerOptions(disableUntil:boolean) : IMyOptions
    {
        ...
        let myDatePickerOptions: IMyOptions = {
            ...
            disableUntil: disableUntil ? { year: dateNow.getFullYear(), month: dateNow.getUTCMonth() + 1, day: dateNow.getDate() - 1 } : { year: dateNow.getFullYear()-1, month: dateNow.getUTCMonth() + 1, day: dateNow.getDate() - 1 },
            height: '34px',
            width: '284px'
        };
